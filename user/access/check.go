...
func (a *Access) GetAllBoardNames(workspace string) ([]*types2.NameList, error) {
	ws, err := a.workspace(workspace)
	if err != nil {
		return nil, err
	}
...
func (a *Access) GetBoardNames(workspace string, uuids []string) (names []*types2.NameList, err error) {
	ws, err := a.workspace(workspace)
	if err != nil {
		return nil, err
	}

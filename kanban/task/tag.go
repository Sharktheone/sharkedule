...
func (t *Task) AddTag(uuid string) error {
	return db.DB.AddTagToTask(t.Workspace, t.UUID, uuid)
}

func (t *Task) RemoveTag(uuid string) error {
	return db.DB.RemoveTagOnTask(t.Workspace, t.UUID, uuid)
}

func (t *Task) SetTags(uuids []string) error {
	return db.DB.SetTagsOnTask(t.Workspace, t.UUID, uuids)
}

func (t *Task) SetDescription(description string) error {
	return db.DB.SetTaskDescription(t.Workspace, t.UUID, description)
}
